                ...
                <div class="row">
                    <form class="col s12" >
                        ...
                        <div class="input-field col s11">
                            ...
                            <label for="icon_prefix"><GiPawPrint size="30px" color="black" />    What's Your Pet's Name</label>
                        </div>
                        <div class="input-field col s11">
                        <textarea id="textarea" type="text" class="validate" />
                        <label for="textarea"><GiTalk size="30px" color="black" />    Tell Us About Your Pet</label>
                        </div>
